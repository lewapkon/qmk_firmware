...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * | Del  | Reset|      |      |      |      |      | Name | User | Mail |      | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |MusMod|Aud on|Audoff|AGnorm|AGswap|Qwerty| Game |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Voice-|Voice+|Mus on|Musoff|MIDIon|MIDIof|Pause |Break |PrtScr|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_planck_grid(
  KC_DEL,  RESET,   _______, SCRFULL, SCRRECT, _______, _______, NAME,    USER,    MAIL,    _______, KC_DEL,
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  GAME,    _______, _______, _______,
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  KC_PAUS, KC_BRK,  KC_PSCR, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case NAME:
      if (record->event.pressed) {
        send_string("Pawe" SS_RALT("l") " Koniarski");
      }
      return false;
      break;
    case USER:
      if (record->event.pressed) {
        send_string("lewapkon");
      }
      return false;
      break;
    case MAIL:
      if (record->event.pressed) {
        send_string("pawel@koniar.ski");
      }
      return false;
      break;
    case SCRFULL:
